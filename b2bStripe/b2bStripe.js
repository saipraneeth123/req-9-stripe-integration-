...
import getAccountDetails from '@salesforce/apex/customstripeclass.getAccountDetails';

import updateCreditLimit from '@salesforce/apex/customstripeclass.updateCreditLimit';
        ...
        if(this.paymentType=='PurchaseOrderNumber')
        {
            ...
            if(this.summaryData.GrandTotalAmount < this.summaryData.CreditLimit)
            {
                ...
                const event = new ShowToastEvent({
                    title: 'Error',
                    variant: 'error',
                    message: 'Your Credit Limit is $'+this.summaryData.CreditLimit,
                });
